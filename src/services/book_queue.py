...
from models import BookInfo, QueueItem, QueueStatus
...
class BookQueue:
    ...
    def __init__(self) -> None:
        ...
        self._status_timeout = timedelta(seconds=settings.STATUS_TIMEOUT)  # 1 hour timeout
    ...
    def add(self, book_id: str, book_data: BookInfo, priority: int = 0) -> None:
        ...
        with self._lock:
            ...
            if book_id in self._status and self._status[book_id] not in [
                QueueStatus.ERROR,
                QueueStatus.DONE,
